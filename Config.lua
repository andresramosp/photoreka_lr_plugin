...
-- true = usar estrategias de fallback (fileName+fecha, EXIF) cuando no hay uniqueId
-- false = solo buscar por uniqueId (más estricto, solo fotos exportadas desde Lightroom)
Config.USE_SEARCH_FALLBACK = false
